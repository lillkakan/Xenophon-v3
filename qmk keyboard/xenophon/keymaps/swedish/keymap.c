...
/* layer 1
 * ,------------------------------------------------+ +------------------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  | DEL  | |VLM UP|   6  |   7  |   8  |   9  |   0  | Bksp |
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
 * | TAB  |   Q  |   W  |   E  |   R  |   T  |INSERT| |VLMDWN|   Y  |   U  |   I  |   O  |   P  |  Å   |
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
 ...
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
 * | TAB  |   Q  |  UP  |   E  |   R  |   T  |INSERT| |   7  |   8  |   9  |   I  |   O  |   P  |  Å   |
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		KC_ESC, 	KC_1, 		KC_2, 		KC_3, 		KC_4, 		KC_5, 					KC_DEL, 					KC_VOLU, 				KC_6, 		KC_7, 		KC_8, 		KC_9, 		KC_0, 		KC_BSPC, 
		KC_TAB, 	KC_Q, 		KC_W, 		KC_E, 		KC_R, 		KC_T, 					KC_INS, 					KC_VOLD, 				KC_Y, 		KC_U, 		KC_I, 		KC_O, 		KC_P, 		SE_ARNG, 
	...
	[1] = LAYOUT(
		...
		KC_TRNS, 	KC_TRNS, 	KC_UP, 		KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_INS,						KC_P7, 		KC_P8, 		KC_P9, 		KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 
		KC_TRNS, 	KC_LEFT,	KC_DOWN, 	KC_RIGHT, KC_TRNS, 	KC_TRNS, 	KC_PGUP, 					KC_P4, 		KC_P5, 		KC_P6, 		KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 
		KC_TRNS,	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_PGDN, 					KC_P1, 		KC_P2, 		KC_P3, 		KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 
