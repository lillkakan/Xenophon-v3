 ...
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
 * | TAB  |   Q  |   W  |   E  |   R  |   T  | DEL  | |VLMDWN|   Y  |   U  |   I  |   O  |   P  |  /   |
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
 * | CAPS |   A  |   S  |   D  |   F  |   G  |  UP  | | PLAY |   H  |   J  |   K  |   L  |   ;  |  '   |
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
 ...
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
 * | TAB  |   Q  |  UP  |   E  |   R  |   T  | DEL  | |   7  |   8  |   9  |   I  |   O  |   P  |   /  |
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
 * | CAPS | LEFT | DOWN | RIGHT|   F  |   G  | pgup | |   4  |   5  |   6  |   K  |   L  |   ;  |  '   |
 * |------+------+------+------+------+------+------+ +------+------+------+------+------+------+------|
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_TAB, 	KC_Q, 		KC_W, 		KC_E, 		KC_R, 		KC_T, 					KC_DEL, 					KC_VOLD, 				KC_Y, 		KC_U, 		KC_I, 		KC_O, 		KC_P, 		KC_SLSH, 
		KC_CAPS, 	KC_A, 		KC_S, 		KC_D, 		KC_F, 		KC_G, 					KC_UP, 						KC_MPLY, 				KC_H, 		KC_J, 		KC_K, 		KC_L, 		KC_SCLN, 	KC_QUOT, 
		KC_LSFT, 	KC_NUBS, 	KC_Z, 		KC_X, 		KC_C, 		KC_V, 					KC_DOWN, 					KC_HOME, 				KC_B, 		KC_N, 		KC_M, 		KC_COMM, 	KC_DOT, 	KC_LSFT, 
		KC_LCTL, 	KC_LGUI, 	KC_LBRC, 	KC_RBRC, 	KC_LALT, 	KC_SPC, 	LT(1, KC_ENT), 		LT(1, KC_ENT),				KC_SPC, 	KC_RALT, 	KC_EQL, 	KC_MINS, 	KC_RGUI, 	KC_LCTL ),

	[1] = LAYOUT(
		KC_TRNS, 	KC_F1, 		KC_F2, 		KC_F3, 		KC_F4, 		KC_F5, 	 	KC_F6, 						KC_F7, 		KC_F8, 		KC_F9, 		KC_F10, 	KC_F11, 	KC_F12, 	KC_TRNS,
		KC_TRNS, 	KC_TRNS, 	KC_UP, 		KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS,					KC_P7, 		KC_P8, 		KC_P9, 		KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 
		KC_TRNS, 	KC_LEFT,	KC_DOWN, 	KC_RIGHT, KC_TRNS, 	KC_TRNS, 	KC_PGUP, 					KC_P4, 		KC_P5, 		KC_P6, 		KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 
